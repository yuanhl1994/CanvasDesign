...
$(document).ready(function() {
	...
	$(".fontsize").bind("click", function() {
		if (fontsizeState == 0) {
			...
			$(".selectFontSize").show();
			fontsizeState = 1;
			$(".font_div #mCSB_5 #mCSB_5_container").css("top",-50);
		} else {
			$(this).find("img").attr("src", "../images/mipmap-xhdpi/up.png");
			$(".selectFontSize").hide();
			fontsizeState = 0;
	...
	$(".border_width").bind("click", function() {
		if (borderWidthState == 0) {
			...
			borderWidthState = 1;
			$(".font_div #mCSB_5 #mCSB_5_container").css("top",-100);
		} else {
			$(this).find("img").attr("src", "../images/mipmap-xhdpi/up.png");
			$(".selectBorderWidth").hide();
			borderWidthState = 0;
	...
	$(".fc").click(function(){
		$(".fontfam").find("img").attr("src", "../images/mipmap-xhdpi/up.png");
		$(".fontcontent").hide();
		fontfamCheck = 0;
	});
...
$(document).on("click", ".frame_box_header>span,.FAdd_btn", function() {
