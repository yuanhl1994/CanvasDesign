...
function loadPage(page, pageElement) {
    ...
    //var img = $('<img />');
	var $pp =$('<canvas width="300" height="300"></canvas>');
    $pp.mousedown(function(e) {
        e.preventDefault();
    });
	...
	pageElement.find('.loader').remove();
    // Load the page
    //img.attr('src', '../TurnBook/pages/' + page + '.jpg');
	$pp.attr('id',page);
...
function loadLargePage(page, pageElement) {
    ...
    // // Loadnew page
    // img.attr('src', '../TurnBook/pages/' + page + '-large.jpg');

	var $pp =$('<canvas width="300" height="300"></canvas>');
	var $prevImg = pageElement.find($pp);
	$pp.appendTo(pageElement);
	$prevImg.remove();
	$pp.attr('id',page);
}
